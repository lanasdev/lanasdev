      ...
      {allProjects.map((project: ProjectType, index) => (
        ...
        >
          <DatoImage
            ...
            objectFit="cover"
            objectPosition="50% 0%"
            className="aspect-golden md:aspect-3/1 xl:aspect[6/4] rounded-xl border-2 border-muted-foreground transition-all duration-150 ease-in-out group-hover:scale-103 group-hover:border-foreground group-hover:opacity-80 min-w-full"
