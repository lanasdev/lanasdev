      ...
      <div className="mx-auto pt-48 ">
        <div className="relative isolate overflow-hidden rounded-xl bg-gray-900 px-6 py-24  sm:px-8 ">
          <svg
            ...
            className="lg:left-1/2 lg:-translate-x-1/2 absolute left-1/2 top-1/2 -z-10 h-[64rem] w-[64rem] -translate-y-1/2 [mask-image:radial-gradient(closest-side,white,transparent)] sm:left-full sm:-ml-80 lg:ml-0 lg:translate-y-0"
            aria-hidden="true"
          >
            <circle
              cx={512}
          ...
          <div className="relative flex flex-col items-center justify-between md:flex-row ">
            ...
            <fieldset className="flex flex-col items-stretch justify-stretch md:flex-row md:justify-around md:gap-x-4 ">
              <input
                id="email"
                type="email"
                placeholder="hallo@lanas.dev"
                className="mb-4 rounded-md text-gray-800 md:mb-0 md:ml-4"
              />
              <button
                className="rounded-md bg-gray-800 hover:bg-gray-600 transition-color duration-200 delay-75 px-4 py-2 text-gray-100"
                type="submit"
              >
                Submit
              </button>
